...
class CDischargeDlg : public CDialogEx
{
public:
    CDischargeDlg(CWnd* pParent = nullptr) : CDialogEx(IDD_DISCHARGE_DIALOG, pParent) {}

    // Pass-in data
    void SetData(float initialPct, float currentPct, float ratePctPerMin,
